/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+batch+csharp+scss&plugins=normalize-whitespace */
...
! function (e) {
    ...
    e.languages.csharp = e.languages.extend("clike", {
        ...
        "defaults": {
            pattern: s("\\b(Int16|Int32|Int64|Math|Encoding|Thread|JsonSerializer|CascadiumOptions|CascadiumCompiler|Console|File|Path)\\b", [x]),
            alias: "class-name"
        },
